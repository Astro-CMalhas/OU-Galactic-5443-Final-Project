...
\digitalasset
\tablewidth{0pt}
\tablecaption{Sample Selection \label{tab:description}}
\tablehead{
\colhead{Feature} & \colhead{Units} & \colhead{Label} & \colhead{Explanation}
}
\startdata
logg_xgboost & --- & Model & Model identifier \\
teff_xgboost & --- & Component & Component identifier \\
mh_xgboost & $\rm km~s^{-1}$ & Shift & Line shift \\
